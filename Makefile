...
build/texlive-%.txt: source/texmfrepo/install-tl
	...
	TEXLIVE_INSTALL_NO_RESUME=1 strace -f -v -s 1024 -e trace=execve ./source/texmfrepo/install-tl --repository source/texmfrepo --profile build/texlive-$*.profile --custom-bin $(ROOT)/build/native/custom_bin
