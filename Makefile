...
build/native/busytex: 
	mkdir -p $(dir $@)
	$(CC) --unresolved-symbols=ignore-all -c busytex.c -o $@.o -DBUSYTEX_KPSEWHICH -DBUSYTEX_BIBTEX8 -DBUSYTEX_XDVIPDFMX -DBUSYTEX_XETEX -DBUSYTEX_LUATEX #-DBUSYTEX_PDFTEX 
