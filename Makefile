...
PDFTEX_EXTERN =  c f ruleht ruledp rulewd g lq lr  hc hn ha hb hf hu hyfchar curlang initcurlang lhyf rhyf initlhyf initrhyf hyfbchar hyf initlist initlig initlft hyphenpassed curl curr curq ligstack ligaturepresent lfthit rthit trietrl trietro trietrc hyfdistance hyfnum hyfnext opstart hyphword hyphlist hyphlink hyphcount hyphnext zzzab  k l debugformatfile expanddepthcount mltexenabledp accentc basec replacec baseslant accentslant basexheight basewidth baseheight accentwidth accentheight delta synctexoffset xord discptr bestplglue bestplshort fillwidth saroot writeopen writefile pagesofar triemin trieopval trieoplang trieused opstart hyfnext hyfnum hyfdistance iac ibc  hyf hu hc nameoffile namelength zzzab 
