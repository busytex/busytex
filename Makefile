...
build/%/busytex build/%/busytex.js: 
	mkdir -p $(dir $@)
	$(CC_$*) -c busytex.c -o $(basename $@).o $(OPTS_BUSYTEX_COMPILE) $(OPTS_BUSYTEX_COMPILE_$*)
	$(CXX_$*) $(OPTS_BUSYTEX_LINK_$*) $(CFLAGS_OPT_$*) -o $@ $(basename $@).o $(addprefix -Ibuild/$*/, $(CPATH_BUSYTEX)) -ldl -lm
...
build/%/perl/busytex_perltools.a: source/perl.downloaded
	...
	./emperl
	$(CXX_$*)  -o busytex emperl.c -DBUSYTEX_FMTUTILUPDMAP -Ibuild/$*/perl -Wl,-E -fstack-protector-strong -I/usr/local/include -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 -Ibuild/$*/perl/prefix/lib/perl5/5.35.4/x86_64-linux/CORE    -Wl,--unresolved-symbols=ignore-all -Wimplicit -Wreturn-type -pthread -L/usr/local/lib build/$*/perl/prefix/lib/perl5/5.35.4/x86_64-linux/auto/Fcntl/Fcntl.a build/$*/perl/prefix/lib/perl5/5.35.4/x86_64-linux/auto/IO/IO.a build/$*/perl/prefix/lib/perl5/5.35.4/x86_64-linux/CORE/libperl.a -lpthread -ldl -lm -lutil -lc -lm -fwrapv -fno-strict-aliasing -fstack-protector-strong  $(CFLAGS_OPT_$*) $(addprefix -Ibuild/$*/, $(CPATH_BUSYTEX))
