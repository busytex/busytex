...
OPTS_BUSYTEX_LINK = -static -static-libstdc++ -static-libgcc -static
...
build/native/busytexapplets build/wasm/busytexapplets:
	...
	#
	echo BEGINWEB2C; $(MAKE) -C $(dir $@)texlive/texk/web2c/web2c CFLAGS="$(CFLAGS_OPT_native) $(OPTS_BUSYTEX_LINK_native)" LDFLAGS="$(OPTS_BUSYTEX_LINK_native)"
	echo BEGINLDD1
	-ldd build/native/texlive/texk/web2c/web2c/web2c
	echo ENDLDD1
