...
OPTS_BUSYTEX_COMPILE_native = -DBUSYTEX_FMTUTILUPDMAP -I$(ROOT)/build/native/perl -Wl,-E -fstack-protector-strong   -I/usr/local/include -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 -I$(ROOT)/build/native/prefix/lib/perl5/5.35.4/x86_64-linux/CORE 
OPTS_BUSYTEX_LINK_native =  $(OPTS_BUSYTEX_COMPILE) -Wl,--unresolved-symbols=ignore-all -Wimplicit -Wreturn-type -pthread build/native/perl/busytex_perltools.a -L/usr/local/lib $(ROOT)/build/native/prefix/lib/perl5/5.35.4/x86_64-linux/auto/Fcntl/Fcntl.a $(ROOT)/build/native/prefix/lib/perl5/5.35.4/x86_64-linux/auto/IO/IO.a  -L$(ROOT)/build/native/prefix/lib/perl5/5.35.4/x86_64-linux/CORE -lperl -lpthread -lnsl -ldl -lm -lutil -lc -lm -fwrapv -fno-strict-aliasing -pipe -fstack-protector-strong 
